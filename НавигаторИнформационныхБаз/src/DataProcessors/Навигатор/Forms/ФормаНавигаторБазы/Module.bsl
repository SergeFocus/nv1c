...
&НаКлиенте
Процедура СтруктураМетаданныхКонфигурацииВыбор(Элемент, ВыбраннаяСтрока, Поле,
...
&НаКлиенте
Процедура ОткрытьЭлементПоНавигационнойСсылкеВРедактореЗавершение(НавигационнаяСсылка,
...
Процедура СкрытьПоказатьПанельИзбранныхЭлементов()
	...
	Элементы.КомандаСкрытьПоказатьПанельИзбранныхЭлементовБыстрая.Пометка = Элементы.ИзбранныеЭлементы.Видимость;
...
Процедура ДобавитьСписокЭлементовОбъектаМетаданных(СтрокаСтруктуры,
	...
	РеквизитФормы = Новый РеквизитФормы(ИмяСпискаЭлементов, Новый ОписаниеТипов("ДинамическийСписок"), , СтрокаСтруктуры.ИмяЭлементаКоллекции
		+ "." + СтрокаСтруктуры.Имя);
...
Процедура ДобавитьПодменюДопКомандСписка(СписокЭлементов, Подменю)
	...
	ИмяПодменю = ЭтаОбработка.ПодставитьПараметрыВСтроку("Подменю"
		+ Объект.Система_РазделительЧастейИмен + "%1"
		+ Объект.Система_РазделительЧастейИмен + "ДопКоманды", СписокЭлементов.Имя);
...
&НаСервере
Процедура ДобавитьКомандуНастройкиКолонокСпискаЭлементовОМ(СписокЭлементов,
		Подменю = Неопределено)
...
&НаСервере
Процедура ДобавитьКомандуЗакрытияСпискаЭлементовОМ(СписокЭлементов,
		Подменю = Неопределено)
...
&НаСервере
Процедура ДобавитьСтраницуСпискаЭлементовОМ(СтрокаСтруктурыМетаданныхКонфигурации,
		СтраницаСписка)
...
&НаСервере
Функция ИмяКолонкиСпискаЭлементовОМ(ИмяКолонки,
...
Функция ПараметрыКолонокСпискаЭлементовОМ(СтрокаСтруктурыМд)
	...
	Результат = ЭтаОбработка().ПараметрыКолонокСпискаЭлементовОМ(СтрокаСтруктурыМд.ИмяКоллекции, СтрокаСтруктурыМд.Имя);
...
Функция ИмяДопКомандыСпискаЭлементовОМ(ИмяСпискаЭлементов, ТипДопКоманды)
	...
	Результат = ЭтаОбработка().ПодставитьПараметрыВСтроку("Команда"
		+ Объект.Система_РазделительЧастейИмен + "%1"
		+ Объект.Система_РазделительЧастейИмен
		+ "%2", ТипДопКоманды, ИмяСпискаЭлементов);
...
&НаКлиенте
Процедура Подключаемый_СписокЭлементовОбъектаМетаданных_Выбор(Элемент,
