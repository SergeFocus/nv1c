...
Процедура КомандаОткрытьФормуНастройкиНавигатора(Команда)
	...
	ОткрытьФорму(ПолноеИмяФормы, , ЭтаФорма, Истина, , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
&НаСервере
Процедура ДобавитьКомандуЗакрытияСпискаЭлементовОбъектаМетаданных(СписокЭлементов,
...
&НаСервере
Функция ИмяСтраницыСпискаЭлементовОбъектаМетаданных(СтрокаСтруктурыМетаданныхКонфигурации)
