...
Процедура ДобавитьКоллекциюОбъектовМетаданных(СтруктураМетаданных, СвойстваКоллекции)
	...
	Если ЧастиИмяКоллекции.Количество() > 1 Тогда
		...
		СтрокиСтруктураМетаданных = СтруктураМетаданных.Строки.НайтиСтроки(
...
Функция СтруктураМетаданныхКонфигурации() Экспорт
	...
	ДобавитьПользователейБазы(СтруктураМетаданных);
